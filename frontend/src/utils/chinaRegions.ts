...
export const PROVINCES: ProvinceOption[] = [
  ...
  {
    name: '江苏',
    cities: ['南京', '苏州', '无锡', '常州', '南通', '连云港', '淮安', '盐城', '扬州', '镇江', '泰州', '宿迁', '徐州'],
  },
  ...
  { name: '山东', cities: ['济南', '青岛', '淄博', '枣庄', '东营', '烟台', '潍坊', '济宁', '泰安', '威海', '日照', '滨州', '德州', '聊城', '临沂', '菏泽'] },
  ...
  { name: '广东', cities: ['广州', '深圳', '珠海', '汕头', '佛山', '江门', '湛江', '茂名', '肇庆', '惠州', '梅州', '汕尾', '河源', '阳江', '清远', '东莞', '中山', '潮州', '揭阳', '云浮'] },
  { name: '广西', cities: ['南宁', '柳州', '桂林', '梧州', '北海', '防城港', '钦州', '贵港', '玉林', '百色', '贺州', '河池', '来宾', '崇左'] },
  { name: '海南', cities: ['海口', '三亚', '三沙', '儋州', '文昌', '万宁', '五指山', '琼海', '东方', '临高', '澄迈', '屯昌', '定安', '昌江', '白沙', '琼中', '保亭', '乐东', '陵水'] },
  ...
  { name: '新疆', cities: ['乌鲁木齐', '克拉玛依', '吐鲁番', '哈密', '昌吉', '博尔塔拉', '巴音郭楞', '阿克苏', '克孜勒苏柯尔克孜', '喀什', '和田', '伊犁', '塔城', '阿勒泰', '石河子', '阿拉尔', '图木舒克', '五家渠', '北屯', '铁门关', '双河', '可克达拉', '昆玉', '胡杨河', '新星市', '白杨市'] },
  { name: '香港', cities: ['香港'] },
  { name: '澳门', cities: ['澳门'] },
  { name: '台湾', cities: ['台北', '新北', '桃园', '台中', '台南', '高雄', '基隆', '新竹', '嘉义', '宜兰', '苗栗', '彰化', '南投', '云林', '屏东', '台东', '花莲', '澎湖'] },
];

export const DEFAULT_PROVINCE = '江苏';
export const DEFAULT_CITY = '苏州';

export const getCitiesByProvince = (provinceName: string): string[] => {
  return PROVINCES.find((item) => item.name === provinceName)?.cities || [];
};
