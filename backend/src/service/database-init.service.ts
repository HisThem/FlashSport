...
export class DatabaseInitService implements OnModuleInit {
  ...
  async initializeSampleData() {
    try {
      // 检查是否已有活动数据
      const existingActivities = await this.activityService.getActivities({ page: 1, limit: 1 });
      ...
      const sampleActivities = [
        {
          ...
          cover_image_url: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          location: '市体育中心篮球场',
          start_time: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(), // 2天后
          end_time: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000 + 2 * 60 * 60 * 1000).toISOString(), // 2天后+2小时
          registration_deadline: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000).toISOString(), // 1天后
          max_participants: 20,
        ...
        },
        {
          ...
          cover_image_url: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          location: '金牌健身俱乐部',
        ...
        },
        {
          ...
          cover_image_url: 'https://images.unsplash.com/photo-1551698618-1dfe5d97d256?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          location: '社区活动中心',
          start_time: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000).toISOString(),
          end_time: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000 + 1 * 60 * 60 * 1000).toISOString(),
          registration_deadline: new Date(Date.now() + 0.5 * 24 * 60 * 60 * 1000).toISOString(),
          max_participants: 8,
          status: ActivityStatus.RECRUITING,
          fee_type: FeeType.FREE,
          fee_amount: 0,
        ...
        },
        {
          ...
          cover_image_url: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          location: '大学城足球场',
